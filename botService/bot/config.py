...
class Config:
    ...
    def validate(cls):
        ...
        if not cls.KINOPOISK_API_KEY or cls.KINOPOISK_API_KEY == "your_kinopoisk_key_here":
            raise ValueError(
                "KINOPOISK_API_KEY is not set in .env file.\n"
                "Пожалуйста, получите токен в https://kinopoiskapiunofficial.tech/ и укажите его в .env файле."
            )
